# app/features/recommendation/services/us_recommendation_service.py
...
logger = logging.getLogger("us_recommendation_service")


class UsRecommendationService:
    """추천 관련 비즈니스 로직을 담당하는 서비스"""
    
    def __init__(self, repository: RecommendationRepository):
        self.repository = repository
    
    def get_candidate_tickers(self, days_back: int, country: str = "US") -> Dict[str, Any]:
        """
        추천 후보 티커 목록을 조회합니다.
    ...
    def validate_ticker_eligibility(self, ticker_id: int, days_back: int = 3, country: str = "US") -> Dict[str, Any]:
        """
