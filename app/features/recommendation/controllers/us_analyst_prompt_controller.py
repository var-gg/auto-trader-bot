# app/features/recommendation/controllers/us_analyst_prompt_controller.py
...
from app.features.recommendation.services.us_analyst_ai_service import UsAnalystAIService, ANALYST_RECOMMENDATION_SCHEMA
...
@router.get(
    ...
    description="""
    특정 티커에 대한 애널리스트 AI 프롬프트를 생성합니다.
    ...
    **사용 예시:**
    - `GET /recommendations/analyst-prompt/123` (티커 ID 123에 대한 프롬프트 생성)
    """,
...
def generate_analyst_prompt(
    ...
    try:
        ...
        # 프롬프트 생성 서비스 호출 (UsAnalystAIService 사용)
