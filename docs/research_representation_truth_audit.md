...
| --- | --- | --- | --- |
| exclude row | query insufficient history | backtest_app/research/pipeline.py:955 | harmless |
| exclude row | event library insufficient bars | backtest_app/research/pipeline.py:763 | harmless |
| exclude row | unknown exchange/session metadata is classified as data_quality_missing | backtest_app/research/pipeline.py:760 | likely distorts similarity |
...
| fallback to market proxy | market proxy is session-aware same-exchange by default | backtest_app/research/pipeline.py:470 | acceptable but monitor |
| fallback to self sector proxy | sector proxy falls back to the symbol itself when no same-exchange peer exists | backtest_app/research/pipeline.py:527 | likely distorts similarity |

## History Scope

| Scope | Value | Line Reference |
| --- | --- | --- |
| feature_window_bars | 60 | backtest_app/research/pipeline.py:86 |
| loaded_warmup_bars | max(120, feature_window_bars * 2) | backtest_app/historical_data/local_postgres_loader.py:106 |
| event_memory_actual_usage | feature_end_date <= decision_date and outcome_end_date < decision_date inside decision-window build | backtest_app/research/pipeline.py:771 |
| query_window_scope | spec.feature_window_bars trailing bars ending at decision_date | backtest_app/research/pipeline.py:957 |
| macro_join_scope | latest series observation whose source_ts_utc <= feature_anchor_ts_utc | backtest_app/research/pipeline.py:241 |
...
| market/sector proxy alignment | same-exchange session-aware proxy | backtest_app/research/pipeline.py:533 | acceptable but monitor |
| sector proxy self fallback | still enabled for missing peers | backtest_app/research/pipeline.py:527 | likely distorts similarity |
| regime gate source | normalized regime context is primary path | backtest_app/research/pipeline.py:670 | acceptable but monitor |
...
| breadth similarity path | disabled from similarity, explicit missingness only | backtest_app/research/pipeline.py:41 | acceptable but monitor |
